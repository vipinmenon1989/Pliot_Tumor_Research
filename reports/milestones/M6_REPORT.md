...
> [!IMPORTANT]
> **Status of Recommendations**: All resolutions and parameters listed in this report are **computational recommendations** generated by automated heuristics. They do **not** represent final researcher-approved clustering selections, which have not yet been selected. The final selections will be made by researchers after visual inspection of the full resolution sweep UMAP grids and individual resolution plots.
