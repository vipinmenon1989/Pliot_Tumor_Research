...
*Generated on: 2026-07-08 19:31:39*
...
| **Max Features** | `> 6000` | 1326 | 15.90% |
| **Min Counts** | `< 500` | 0 | 0.00% |
| **Max Counts** | `> 50000` | 40 | 0.48% |
| **Max percent.mt** | `> 15.0%` | 0 | 0.00% |
| **Max percent.ribo** | `> 20.0%` | 26 | 0.31% |
| **Combined Filters** | **All Above** | **1352** | **16.21%** |

### Summary of Expected Kept Cells:
- **Total cells before filtering**: 8338
- **Expected cells removed**: 1352 (16.21%)
- **Expected cells retained**: 6986 (83.79%)
...
2. **Do you approve the mitochondrial limit of 15.0% for MPNST_1?** (Excludes 0 cells)
3. **Do you approve the ribosomal limit of 20.0% for MPNST_1?** (Excludes 26 cells)
4. **Do you approve the overall threshold combination which will exclude 16.21% of cells?**
