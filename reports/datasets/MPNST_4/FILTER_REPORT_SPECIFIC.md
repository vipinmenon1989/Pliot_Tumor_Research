...
*Generated on: 2026-07-09 09:30:18*
...
| **Retained Singlets (M3)** | 6877 | 88.04% |
| **Excluded Cells (Total)** | 934 | 11.96% |
...
| **Max percent.mt** | `> 20.0%` | 0 | 0.00% |
| **Max percent.ribo** | `> 30.0%` | 218 | 2.79% |
...
- **Doublet Detection Runtime**: `62.32 seconds`
...
For MPNST_4, the 10% MT threshold excluded 0 cells (0.00%), effectively removing cells with signs of stress or lysis.
