# Dataset Validation Report - MPNST_4
*Generated on: 2026-07-08 19:30:20*
...
| **Cells** | 7,811 |
| **Genes** | 29,708 |
| **Dimensions** | 29708 x 7811 |
| **Default Assay** | SCT |
| **Object Size in Memory** | 3224.13 MB |
| **File Path** | `results/datasets/MPNST_4/MPNST_4_raw.rds` |
| **MD5 Checksum** | `f32811cf69595dcab9c5f5067efccbaa` |

## 2. Assay Structure

| Assay | Class | Features | Layers | Counts Present? |
| --- | --- | --- | --- | --- |
| RNA | Assay5 | 31,764 | counts.MPNST_4, data.MPNST_4, scale.data | YES |
