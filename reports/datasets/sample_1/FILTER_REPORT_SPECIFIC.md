# Milestone 3 QC and Doublet Filtering Report - sample_1
*Generated on: 2026-07-09 09:23:23*
...
- **Doublet Detection Runtime**: `36.09 seconds`
...
For sample_1, the 10% MT threshold excluded 0 cells (0.00%), effectively removing cells with signs of stress or lysis.
...
- **Input Raw File**: `results/datasets/sample_1/sample_1_raw.rds`
- **Input Checksum**: `d00c72f0968f6cdfd1ee9e0151329c85`
