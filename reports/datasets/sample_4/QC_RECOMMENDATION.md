# QC Recommendation Report - sample_4
*Generated on: 2026-07-08 19:26:07*
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| **nCount_RNA** | 8005 | 8882.0 | 8347 | 10349 | 8064 | 8124 | 8156 | 10155 | 10214 | 10273 |
| **nFeature_RNA** | 120 | 120.0 | 120 | 120 | 120 | 120 | 120 | 120 | 120 | 120 |
| **percent.mt** | 4.90% | 6.14% | 6.35% | 7.18% | 4.95% | 5.11% | 5.27% | 6.80% | 6.88% | 7.09% |
| **percent.ribo** | 8.35% | 10.28% | 10.73% | 11.76% | 8.54% | 8.73% | 8.86% | 11.22% | 11.34% | 11.63% |

## 2. Potential Outliers

Based on statistical distributions (e.g. median +/- 3 Median Absolute Deviations (MAD) or standard deviation thresholds):

- **Library Depth (nCount_RNA)**: The median value is 8347. Outliers are typically defined as cells with counts below 7700 or above 8994.
...
- **Mitochondrial Fraction (percent.mt)**: The median is 6.35%, and the 95th percentile is 6.88%. Cells exceeding 6.88% show elevated mitochondrial expression indicating cellular stress or lysis.
...
| **Max Features** | `> 6000` | 0 | 0.00% |
| **Min Counts** | `< 500` | 0 | 0.00% |
| **Max Counts** | `> 50000` | 0 | 0.00% |
| **Max percent.mt** | `> 15.0%` | 0 | 0.00% |
...
2. **Do you approve the mitochondrial limit of 15.0% for sample_4?** (Excludes 0 cells)
3. **Do you approve the ribosomal limit of 20.0% for sample_4?** (Excludes 0 cells)
