...
*Generated on: 2026-07-09 09:28:13*
...
| **Retained Singlets (M3)** | 2284 | 80.71% |
| **Excluded Cells (Total)** | 546 | 19.29% |
...
| **Max percent.ribo** | `> 30.0%` | 220 | 7.77% |
...
- **Doublet Detection Runtime**: `49.19 seconds`
...
For MPNST_2, the 10% MT threshold excluded 111 cells (3.92%), effectively removing cells with signs of stress or lysis.
