# Dataset Validation Report - MPNST_3
...
| **Cells** | 3,682 |
| **Genes** | 29,708 |
| **Dimensions** | 29708 x 3682 |
| **Default Assay** | SCT |
| **Object Size in Memory** | 1455.99 MB |
| **File Path** | `results/datasets/MPNST_3/MPNST_3_raw.rds` |
| **MD5 Checksum** | `ecaca4b46e0a23f7bb8798cdb6adf280` |

## 2. Assay Structure

| Assay | Class | Features | Layers | Counts Present? |
| --- | --- | --- | --- | --- |
| RNA | Assay5 | 31,764 | counts.MPNST_3, data.MPNST_3, scale.data | YES |
