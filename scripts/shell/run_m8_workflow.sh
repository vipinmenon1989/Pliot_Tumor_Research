#!/bin/bash
#SBATCH --job-name=m8_real_workflow
#SBATCH --account=ihc
...
#SBATCH --output=logs/slurm/m8_workflow_%j.out
#SBATCH --error=logs/slurm/m8_workflow_%j.err
...
echo "Executing Snakemake workflow for Milestone 8..."
