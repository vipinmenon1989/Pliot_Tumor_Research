#!/bin/bash
#SBATCH --job-name=m4_real_workflow
#SBATCH --account=ihc
...
#SBATCH --output=logs/slurm/m4_workflow_%j.out
#SBATCH --error=logs/slurm/m4_workflow_%j.err
...
echo "Executing Snakemake workflow for Milestone 4..."
