#!/bin/bash
#SBATCH --job-name=m3_real_workflow
#SBATCH --account=ihc
...
#SBATCH --output=logs/slurm/m3_workflow_%j.out
#SBATCH --error=logs/slurm/m3_workflow_%j.err
...
echo "Executing Snakemake workflow for Milestone 3..."
