#!/bin/bash
#SBATCH --job-name=m5_real_workflow
#SBATCH --account=ihc
...
#SBATCH --output=logs/slurm/m5_workflow_%j.out
#SBATCH --error=logs/slurm/m5_workflow_%j.err
...
echo "Executing Snakemake workflow for Milestone 5..."
